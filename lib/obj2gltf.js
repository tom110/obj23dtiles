...
const defined = Cesium.defined;//检验object是否被defined
...
function obj2gltf(objPath, options) {
    ...
    if (options.metallicRoughness + options.specularGlossiness + options.unlit > 1) {
        throw new DeveloperError('[metallicRoughness, specularGlossiness, unlit]三种材质只有一种能被设置.');
    }
